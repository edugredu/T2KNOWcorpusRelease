...
This file defines the official benchmark for T2KNOW-Core v1.0.0. All paper claims refer to these files and this configuration.
...
- **432 records**: source text included (high-confidence source matches, permissive redistribution evidence)
- **389 records**: source text excluded (source identifiers, checksums, and reconstruction metadata provided)

Public-redacted evaluation (annotation-only, no source text) can verify all paper benchmark claims for the text-included subset and structural/annotation claims for all 821 records. Full training over all 821 documents requires lawful user-side reconstruction of text-excluded records per `docs/reconstruction.md`.
